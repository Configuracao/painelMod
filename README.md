...
```sh
apt update -y; apt install wget -y; wget https://raw.githubusercontent.com/Configuracao/painelMod/main/i.sh; chmod 777 i.sh; ./i.sh
```
...
```sh
git clone https://github.com/Configuracao/painelMod.git
```
